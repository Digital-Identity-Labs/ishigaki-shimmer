base_name = "digitalidentity/ishigaku-shimmer"
...
task :test => [:build] do
  begin
    ...
    sh "bundle exec inspec exec specs/ishigaki-shimmer/ #{colour} --chef-license=accept-silent -t docker://#{container_id} "
  ensure
...
task :push do
  ...
  repo = "digitalidentity/ishigaki-shimmer"
